...
public class PostsRVAdaptor extends RecyclerView.Adapter<PostsRVAdaptor.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostsRVAdaptor.ViewHolder holder, int position) {
        ...
        holder.userName.setText(post.getUserName().equals("null") ? "No username found" : post.getUserName());
        holder.description.setText(post.getDescription().equals("null") ? "No description found" : post.getDescription());
